        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="Calma sleep sounds app screenshot 1"
              width={720}
              height={1600}
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="Calma sleep sounds app screenshot 2"
              width={720}
              height={1600}
              className="h-auto w-full rounded-2xl"
            />
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="Calma sleep sounds app screenshot 3"
              width={720}
              height={1600}
              className="h-auto w-full rounded-2xl"
            />
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="Calma sleep sounds app screenshot 4"
              width={720}
              height={1600}
              className="h-auto w-full rounded-2xl"
            />
