    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 text-center">
        ...
        <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl">
          より良い睡眠とより穏やかなオーディオ環境のためのブラウンノイズアプリ
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-white/70 sm:text-lg">
          Calmaは、睡眠、リラクゼーション、そして日常の落ち着きのために、より柔らかく制御された音環境を作成するのに役立つ、美しくシンプルなブラウンノイズアプリです。就寝時のルーティンをサポートし、気を散らすノイズを減らし、あなたの周りにより平和な雰囲気を構築するために使用してください。
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 leading-7 text-white/70">
              ブラウンノイズは、就寝時により安定した音の背景を作成し、睡眠へのより穏やかな移行をサポートするのに役立ちます。
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 leading-7 text-white/70">
              Calmaは、エレガントで明確、そして感情的に軽く感じられるように設計されており、ブラウンノイズが技術的なツールではなく、日常のルーティンの一部のように感じられるようにサポートします。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="睡眠と集中のためにブラウンノイズをカスタマイズするためのCalmaブラウンノイズアプリインターフェース"
              width={720}
              height={1600}
              className="h-auto w-full rounded-2xl"
            />
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="カスタムブラウンノイズミックスを作成するためのCalmaサウンドミキサーインターフェース"
              width={720}
              height={1600}
              className="h-auto w-full rounded-2xl"
            />
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            <h3 className="text-xl font-semibold text-white">睡眠のためのブラウンノイズ</h3>
            <p className="mt-3 text-white/70">
              ブラウンノイズが安定した就寝環境を作成し、休息を改善するのにどのように役立つかを発見してください。
            </p>
          </a>
          <a
          ...
          >
            ...
            <p className="mt-3 text-white/70">
              ブラウンノイズ、ピンクノイズ、ブラウンノイズ、グリーンノイズの違いを探り、理想的な音を見つけてください。
            </p>
          </a>
        </div>
      </section>
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-3 leading-7 text-white/70">
              ブラウンノイズアプリは、睡眠、リラクゼーション、そしてより穏やかな音環境をサポートできる一定の背景音を作成するのに役立ちます。
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-3 leading-7 text-white/70">
              多くの人がブラウンノイズを使用して、就寝時をより穏やかに感じ、環境内の気を散らす音の影響を軽減しています。
            </p>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 text-center">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-10 shadow-2xl shadow-black/20 sm:p-12">
          ...
          <p className="mt-4 leading-7 text-white/70">
            Google PlayでCalmaをダウンロードし、ブラウンノイズとパーソナライズされたサウンドスケープでより穏やかな音環境を作成してください。
          </p>
