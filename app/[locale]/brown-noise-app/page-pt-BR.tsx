...
export const metadata: Metadata = {
  ...
  description:
    "Procurando ruído marrom profundo para TDAH, sono ou concentração? Misture ruído marrom com chuva e sons da natureza. 100% grátis, sem anúncios, funciona offline.",
  keywords: [
