...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sleep tinnitus relief sounds app",
    "calming tinnitus relief sounds",
    "calma tinnitus relief sounds",
  ],
  alternates: {
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            <h3 className="text-xl font-semibold text-white">Tinnitus Relief for Sleep</h3>
            <p className="mt-3 text-white/70">
              Discover how tinnitus relief sounds can help create a stable bedtime environment and improve your rest.
            </p>
          </a>
          <a
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              What is a tinnitus relief sounds app?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
              A tinnitus relief sounds app helps create a steady background sound that can
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Can tinnitus relief sounds help with sleep?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
              Many people use tinnitus relief sounds to make bedtime feel calmer and reduce
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Is Calma only for tinnitus relief sounds?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
