...
export const metadata: Metadata = {
  title: "Enlaces Oficiales de Calma & Redes | Calma",
  description:
    "Encuentra los enlaces oficiales de Calma, descarga la aplicación en Google Play y conéctate con nosotros en redes.",
  alternates: {
