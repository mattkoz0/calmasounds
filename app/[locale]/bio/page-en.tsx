...
export const metadata: Metadata = {
  title: "Calma Official Links & Social Channels | Calma",
  description:
    "Find official Calma links, download the app on Google Play and App Store, and connect with us on social media.",
  alternates: {
