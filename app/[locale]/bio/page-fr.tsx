...
export const metadata: Metadata = {
  title: "Liens Officiels Calma & Réseaux Sociaux | Calma",
  description:
    "Trouvez les liens officiels de Calma, téléchargez l'application sur Google Play et connectez-vous avec nous.",
  alternates: {
