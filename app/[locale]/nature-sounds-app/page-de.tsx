...
export const metadata: Metadata = {
  ...
  keywords: [
    "Naturklänge App",
    "White Noise App",
    "Naturklänge zum Einschlafen",
    "beruhigendes Naturklänge",
    "Calma White Noise",
  ],
  alternates: {
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            <h3 className="text-xl font-semibold text-white">Naturklänge zum Schlafen</h3>
            <p className="mt-3 text-white/70">
              Entdecke, wie Naturklänge helfen kann, eine stabile Umgebung zu schaffen und deine Erholung zu verbessern.
            </p>
          </a>
          <a
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Hilft Naturklänge beim Schlafen?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
