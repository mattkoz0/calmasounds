...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "App de Sons da Natureza",
      "item": "https://www.calmasounds.com/pt-BR/nature-sounds-app"
    }
  ]
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 text-center">
        <p className="text-sm uppercase tracking-[0.25em] text-white/50">
          App de sons da natureza
        </p>
        <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl">
          Um aplicativo de sons da natureza para um sono melhor e um ambiente de áudio mais calmo
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-white/70 sm:text-lg">
          O Calma é um aplicativo de sons da natureza incrivelmente simples que ajuda você a criar um
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 leading-7 text-white/70">
              O sons da natureza pode ajudar a criar um fundo sonoro mais estável para a
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 leading-7 text-white/70">
              ...
              ajudando o sons da natureza a parecer parte de uma rotina diária em vez de uma
              ferramenta técnica.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-3">
            <Image
              ...
              alt="Interface do misturador de som Calma para criar mixagens personalizadas de sons da natureza"
              width={720}
              height={1600}
              className="h-auto w-full rounded-2xl"
            />
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">
            Aprenda mais sobre sons da natureza
          </h2>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            <h3 className="text-xl font-semibold text-white">Sons da Natureza para Dormir</h3>
            <p className="mt-3 text-white/70">
              Descubra como o sons da natureza pode ajudar a criar um ambiente estável para a hora de dormir e melhorar o seu descanso.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p className="mt-3 text-white/70">
              Explore as diferenças entre o sons da natureza, rosa, marrom e verde para encontrar o seu som ideal.
            </p>
          </a>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">
            FAQ do app de sons da natureza
          </h2>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 text-center">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-10 shadow-2xl shadow-black/20 sm:p-12">
          ...
          <p className="mt-4 leading-7 text-white/70">
            ...
            com sons da natureza e paisagens sonoras personalizadas.
          </p>
