...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "dźwięki natury aplikacja",
    "kojący dźwięki natury",
    "dźwięki natury dla niemowląt",
    "calma dźwięki natury",
  ],
  alternates: {
...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.calmasounds.com/pl/nature-sounds-app"
    }
  ]
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 text-center">
        ...
        <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl">
          Dźwięki natury dla lepszego snu i spokojniejszego otoczenia
        </h1>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 leading-7 text-white/70">
              Dźwięki natury pomaga stworzyć bardziej stabilne tło dźwiękowe przed snem
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 leading-7 text-white/70">
              Calma jest zaprojektowana tak, aby dźwięki natury stał się naturalną częścią Twojej rutyny,
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            <h3 className="text-xl font-semibold text-white">Dźwięki natury do snu</h3>
            <p className="mt-3 text-white/70">
              Dowiedz się, jak dźwięki natury pomaga stworzyć stabilne otoczenie wieczorem i poprawić jakość odpoczynku.
            </p>
          </a>
          <a
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Czy dźwięki natury pomaga w spaniu?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Czy Calma oferuje tylko dźwięki natury?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
