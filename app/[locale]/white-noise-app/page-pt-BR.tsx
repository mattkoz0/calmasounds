...
export const metadata: Metadata = {
  title: "App de Ruído Branco | Calma",
  description:
    "Descubra o Calma, um aplicativo de ruído branco incrivelmente simples para dormir, relaxar e criar um ambiente de áudio mais calmo.",
  keywords: [
  ...
  openGraph: {
    title: "App de Ruído Branco | Calma",
    description:
      "Descubra um aplicativo de ruído branco incrivelmente simples para dormir, relaxar e rotinas diárias mais calmas.",
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              O que é um aplicativo de ruído branco?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
              Um aplicativo de ruído branco ajuda a criar um som de fundo constante que pode
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              O ruído branco pode ajudar com o sono?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
              Muitas pessoas usam o ruído branco para tornar a hora de dormir mais calma e reduzir
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              O Calma é apenas para ruído branco?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
