...
export async function generateMetadata({params}: {params: Promise<{locale: string}>}) {
  ...
  else if (locale === 'es') baseMetadata = (await import('./page-es')).metadata;
  ...
  return getLocalizedMetadata(locale, "/best-sleep-sounds-app-without-subscription", baseMetadata);
}
...
export default async function Page({params}: {params: Promise<{locale: string}>}) {
  ...
  else if (locale === 'es') return <EsPage />;
  ...
  else if (locale === 'pt-BR') return <PtBrPage />;
