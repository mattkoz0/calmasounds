...
export const metadata: Metadata = {
  title: "Sons de Pluie vs Bruit Blanc pour Dormir | Calma",
  description:
    "Comparez les sons de pluie et le bruit blanc pour découvrir ce qui fonctionne le mieux pour dormir et se détendre.",
  keywords: [
