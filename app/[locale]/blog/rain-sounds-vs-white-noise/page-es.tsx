...
export const metadata: Metadata = {
  title: "Sonidos de Lluvia vs Ruido Blanco | Calma",
  description:
    "Compara los sonidos de lluvia y el ruido blanco para descubrir qué funciona mejor para dormir y relajarse.",
  keywords: [
