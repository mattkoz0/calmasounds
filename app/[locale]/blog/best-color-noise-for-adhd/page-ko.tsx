  ...
  return (
    ...
    >
      ...
      <ArticleSection id="summary" title="결론: ADHD에 가장 좋은 소음 색깔은 무엇일까요?">
        <p>
          모든 ADHD 사람에게 가장 좋은 하나의 노이즈 컬러는 없습니다. 2024년 체계적 문헌고찰에서는 화이트 또는 핑크 노이즈의 작은 평균 효과를 확인했지만, 기준을 충족한 브라운 노이즈 연구는 없었습니다.
        </p>
        <p className="mt-4">
              ...
              "mainEntity": [
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "모두에게 가장 좋은 노이즈 컬러는 없습니다. 2024년 문헌고찰에서는 실험 과제에서 화이트 또는 핑크 노이즈의 작은 평균 효과를 확인했지만 브라운 노이즈 적격 연구는 없었습니다."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "현재 근거로는 그렇다고 할 수 없습니다. 더 깊은 소리를 선호하는 사람도 있지만 반응은 개인마다 다르며 노이즈는 ADHD 치료가 아닙니다."
                  }
                }
              ]
            })
