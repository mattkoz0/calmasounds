  ...
  return (
    ...
    >
      ...
      <ArticleSection id="summary" title="結論：ADHDに最適なノイズの色は何でしょうか？">
        <p>
          ADHDのすべての人に最適なノイズカラーはありません。2024年の系統的レビューではホワイトまたはピンクノイズに小さな平均効果が見られましたが、条件を満たすブラウンノイズ研究はありませんでした。
        </p>
        <p className="mt-4">
              ...
              "mainEntity": [
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "誰にでも最適なノイズカラーはありません。2024年のレビューでは実験課題でホワイトまたはピンクノイズに小さな平均効果が見られましたが、条件を満たすブラウンノイズ研究はありませんでした。"
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "現在の研究では優れているとは言えません。低い音を好む人もいますが反応には個人差があり、ノイズはADHDの治療ではありません。"
                  }
                }
              ]
            })
