...
export const metadata: Metadata = {
  title: "Application de sons relaxants | Calma",
  description:
    "Découvrez Calma, une application de sons relaxants simple et élégante pour des soirées plus calmes, des moments de paix et des paysages sonores personnalisés.",
  keywords: [
  ...
  openGraph: {
    title: "Application de sons relaxants | Calma",
    description:
      "Découvrez une application de sons relaxants simple et élégante pour vos soirées et vos rituels quotidiens paisibles.",
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-3 text-white/70">
              Découvrez comment les sons naturels comme la pluie calment l'esprit.
            </p>
          </Link>
          <Link
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Qu'est-ce qu'une application de sons relaxants ?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
              Elle permet de diffuser des sons apaisants pour favoriser la détente 
              et des moments de calme au quotidien.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-3 leading-7 text-white/70">
              Après le travail, durant vos moments de lecture ou dès que vous avez 
              besoin d'une atmosphère douce autour de vous.
            </p>
          </div>

          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h3 className="text-xl font-semibold">
              Puis-je personnaliser les sons ?
            </h3>
            <p className="mt-3 leading-7 text-white/70">
              Oui, l'essence de Calma est de vous permettre de créer votre propre 
              mélange exclusif plutôt que d'écouter une piste imposée.
            </p>
          </div>
        </div>
      </section>
